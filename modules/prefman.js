var EXPORTED_SYMBOLS = ["vestitools_PrefManager"];

//setValue returns the value passed to it now

var vestitools_PrefManager = new function prefMan() {
	var startPoint="extensions.vestitools.";
	...
	// resets the named preference or subtree
	// not implemented as of Firefox 3.6
	this.reset=function(prefName) {
		pref.resetBranch(prefName);
		}
